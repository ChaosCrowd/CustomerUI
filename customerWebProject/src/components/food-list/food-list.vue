<!-- 菜品列表 -->
<template>
  <mt-index-list :show-indicator=false class="food-list">
...
<style scope>
  ...
  .food-list .mint-indexlist-navlist {
    /* 使左侧索引能独立拉动 */
    overflow-y: auto;
  }
  /* 菜品列表 */
  .food-list .mint-indexlist-content {
    position: relative;
    left: 20%;
    height: 100% !important;
  }
  /* 列表中的索引 */
  .food-list .mint-indexsection-index {
    padding: 0;
    text-align: left;
    margin-left: 2.6vw;
  }
